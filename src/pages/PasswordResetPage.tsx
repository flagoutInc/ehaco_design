  ...
  return (
    <div className="min-h-screen bg-ehaco-bg flex items-center justify-center px-4 fade-in">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={(e: React.FormEvent<HTMLFormElement>) => { e.preventDefault(); setSent(true); }} className="bg-white rounded-2xl ring-1 ring-ehaco-border/50 p-6 space-y-4">
          <div>
            <label className="block text-sm font-medium text-ehaco-text mb-1">メールアドレス</label>
            <input type="email" required value={email} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEmail(e.target.value)}
