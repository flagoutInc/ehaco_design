...
export default function ContactPage(): React.ReactElement {
  const [form, setForm] = useState<ContactForm>({ company: '', lastName: '', firstName: '', email: '', phone: '', message: '', agree: false });
  const [sent, setSent] = useState<boolean>(false);
  const update = <K extends keyof ContactForm>(k: K, v: ContactForm[K]): void => setForm((p) => ({ ...p, [k]: v }));
