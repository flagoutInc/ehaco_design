        ...
        <div className="bg-white rounded-2xl ring-1 ring-ehaco-border/50 p-6">
          ...
          <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 text-sm">
            ...
            <div>
              ...
              <dd className="font-medium text-ehaco-text">{applicant.phone || '—'}</dd>
            </div>
            <div>
              <dt className="text-muted mb-0.5">部署・役職</dt>
              <dd className="font-medium text-ehaco-text">{applicant.department || '経営企画部'} / {applicant.position || 'マネージャー'}</dd>
            </div>
            <div>
              <dt className="text-muted mb-0.5">申込日時</dt>
              <dd className="font-medium text-ehaco-text">{applicant.date} {applicant.time || ''}</dd>
            </div>
          </dl>
        </div>
        ...
        <div className="bg-white rounded-2xl ring-1 ring-ehaco-border/50 p-6">
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-muted">チケット: {applicant.ticket || '一般参加'}</p>
            </div>
          </div>
        </div>
