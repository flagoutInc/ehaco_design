...
const sections = [
  {
    title: 'ehaco!について',
    links: [
      { label: 'ehaco!とは（利用者向け）', href: 'https://ehaco.net/service/participants' },
      { label: 'ehaco!とは（主催者向け）', href: 'https://ehaco.net/service/organizer' },
      { label: '運営会社', href: 'https://ehaco.net/about/company' },
      { label: '会員登録（参加者）', href: 'https://ehaco.net/register' },
      { label: '掲載希望（主催者）', href: 'https://org.ehaco.net/register' },
    ],
  },
  {
    title: 'サポート',
    links: [
      { label: '参加者向け利用規約', href: 'https://ehaco.net/about/terms/participant' },
      { label: '主催者向け利用規約', href: 'https://ehaco.net/about/terms/organizer' },
      { label: '個人情報の取り扱い', href: 'https://ehaco.net/about/privacy' },
    ...
    <div className="border-t border-white/10 md:border-none">
      ...
      <ul className={`space-y-4 overflow-hidden transition-all duration-300 md:!max-h-none md:!opacity-100 md:!pb-0 ${
        ...
        {links.map(({ label, href }) => (
          <li key={label}>
            <a href={href} className="text-sm md:text-base text-white/40 transition hover:text-white">
              {label}
            </a>
          </li>
        ))}
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 md:py-16 md:px-6">
        <div className="grid grid-cols-1 gap-0 md:grid-cols-3 md:gap-10 text-left">
          ...
          <div className="pb-6 md:pb-0">
            <Link to="/">
              <img src="/ehaco_design/ehaco-logo.png" alt="ehaco!" loading="lazy" className="h-8 object-contain brightness-0 invert" />
            </Link>
