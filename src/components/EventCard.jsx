...
function VerticalCard({ event }) {
  return (
    <div className="group overflow-hidden rounded-xl border border-ehaco-border bg-white shadow-sm transition duration-200 hover:-translate-y-1 hover:shadow-lg">
      {/* Image */}
      ...
      <div className="p-4">
        {/* Category badge */}
        <span className="inline-block rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-primary">
          {event.category}
        </span>

        {/* Title */}
        <h3 className="mt-2 line-clamp-2 font-semibold text-ehaco-text">
          <Link
            to={`/event/${event.id}`}
...
function HorizontalCard({ event }) {
  return (
    <div className="group flex overflow-hidden rounded-xl border border-ehaco-border bg-white shadow-sm transition duration-200 hover:shadow-lg">
      {/* Image */}
      ...
      <div className="flex flex-1 flex-col justify-between p-4">
        <div>
          ...
          {/* Title */}
          <h3 className="mt-1.5 line-clamp-2 font-semibold text-ehaco-text">
            <Link
              to={`/event/${event.id}`}
              className="transition hover:text-accent"
            >
