...
export type OrgEvent = {
  ...
  deadline: string;
  status: string;
  tickets: { name: string; capacity: number }[];
};

export type OrgApplicant = {
  id: number;
  appliedAt: string;
  date: string;
  time: string;
...
export const orgStaff: OrgStaffMember[] = [
...
export const orgApplicants: OrgApplicant[] = [
...
export const orgSurveys: OrgSurvey[] = [
...
export const orgTargets: OrgTarget[] = [
